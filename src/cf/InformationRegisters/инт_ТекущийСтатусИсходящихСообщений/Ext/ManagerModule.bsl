...
Функция ПолучитьИдентификаторыСообщенийКФормированию(Количество = 0) Экспорт
    ...
    Запрос.Текст = СтрШаблон("ВЫБРАТЬ %1
                   ...
                   |ГДЕ
                   |    инт_ТекущийСтатусИсходящихСообщений.СтатусСообщения = ЗНАЧЕНИЕ(Перечисление.инт_СтатусыИсходящихСообщений.ОшибкаФормирования)
                   |    И инт_ПотокиДанных.КоличествоПопытокФормирования > инт_ТекущийСтатусИсходящихСообщений.КоличествоПопыток
                   |;
                   |
                   |////////////////////////////////////////////////////////////////////////////////
                   |ВЫБРАТЬ %1
